    ...
    // **CONFIGURAÇÃO DO FIREBASE ADMIN COM SERVICE ACCOUNT**
    const serviceAccount = {
        type: "service_account",
        project_id: "garagem67-c38cf",
        private_key_id: "c8299a4f8ea67b29c07c39daeb67a8bc49eb9a29",
        ...
        client_email: "firebase-adminsdk-fbsvc@garagem67-c38cf.iam.gserviceaccount.com",
        client_id: "105355846483629887329",
        auth_uri: "https://accounts.google.com/o/oauth2/auth",
        token_uri: "https://oauth2.googleapis.com/token",
        auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",
        client_x509_cert_url: "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40garagem67-c38cf.iam.gserviceaccount.com",
    ...
    if (!serviceAccount.project_id || !serviceAccount.client_email || !serviceAccount.private_key) {
        ...
        console.log('Certifique-se de que project_id, client_email e private_key estão definidos');
        process.exit(1);
    }
